<x-guest-layout  :title="'Register - Investor Tracker'">
    <div class="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-blue-900 via-blue-700 to-blue-500 overflow-hidden">
        ...
        <div class="w-full max-w-md px-6 relative z-10">
            <!-- Card -->
            <div class="bg-white/95 backdrop-blur-xl shadow-2xl rounded-3xl p-6 border border-blue-100">
                
                <!-- Logo/Icon -->
                <div class="flex justify-center mb-4">
                    <div class="bg-gradient-to-br from-blue-600 to-blue-800 p-3 rounded-2xl shadow-lg">
                ...
                <div class="text-center mb-5">
                    ...
                    <p class="text-gray-600 text-sm">Join Investor Tracker today</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus
                                class="block w-full pl-10 pr-3 py-2.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 text-sm"
                    ...
                    <!-- Register Button -->
                    <button type="submit" class="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-2.5 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition duration-200 flex items-center justify-center mt-5">
