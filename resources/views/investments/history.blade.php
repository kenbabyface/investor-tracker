<x-app-layout title="Investment History">
    <x-slot name="header">
        <div class="space-y-2 px-4 sm:px-0">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                ...
                <a href="{{ route('investments.history.export') }}" class="w-full sm:w-auto text-center bg-green-600 hover:bg-green-700 text-white font-bold py-2.5 px-4 sm:px-6 rounded-lg shadow-md transition flex items-center justify-center text-sm">
                    <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
