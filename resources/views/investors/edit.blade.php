        ...
        <div class="space-y-2">
            <nav class="text-sm">
                <ol class="list-none p-0 inline-flex flex-wrap">
                    ...
                    <li class="flex items-center text-gray-500">Edit Investor</li>
                </ol>
            </nav>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-white overflow-hidden shadow-xl sm:rounded-2xl border border-blue-100">
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 p-6 md:p-8">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h3 class="text-2xl font-bold text-white">Update Investor Details</h3>
                            <p class="text-blue-100 text-sm mt-1">Modify the information for {{ $investor->name }}</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-sm border border-blue-100">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="phone" id="phone" value="{{ old('phone', $investor->phone) }}"
                                        class="w-full px-4 py-3 rounded-lg border-2 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition duration-200"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="company" id="company" value="{{ old('company', $investor->company) }}"
                                        class="w-full px-4 py-3 rounded-lg border-2 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition duration-200"
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-sm border border-blue-100">
                            ...
                            <div class="mt-6">
                                ...
                                <textarea name="notes" id="notes" rows="4"
                                    ...
                                    placeholder="Add any additional information about this investor...">{{ old('notes', $investor->notes) }}</textarea>
                                @error('notes')
                                    <p class="mt-2 text-sm text-red-600 flex items-center">
                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg>
                                        {{ $message }}
